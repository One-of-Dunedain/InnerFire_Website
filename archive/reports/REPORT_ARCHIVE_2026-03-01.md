...
### Acceptance Criteria Results
- [x] Zero "вЂ”" characters in any user-visible text across all HTML files — passed
...
### Verification
- PASSED
- Searched all non-archive/task-spec HTML files for em-dash artifacts (`—` and `вЂ”`) — no matches.
